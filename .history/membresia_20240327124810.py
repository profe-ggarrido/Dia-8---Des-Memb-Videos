# ************ DESAFIO MEMBRESIAS DE CLUB DE VIDEOS  *********
# ---------------------------------------------------------------
...
print("********************************************************")
print("*********CLUB DE VIDEOS - POR TIPOS DE MEMBRESIAS*******")
print("")

print("\033[1m\033[42mTIPO DE MEMBRESÍA: \033[0m",type(g))

b = g.cambiar_suscripcion(1)
print("\033[1m\033[44mTIPO DE MEMBRESÍA: \033[0m",type(b))
f = b.cambiar_suscripcion(2)
print("\033[1m\033[45mTIPO DE MEMBRESÍA: \033[0m",type(f))
print(f.dias_regalo)
sc = f.cambiar_suscripcion(3)
print("\033[1m\033[43;31mTIPO DE MEMBRESÍA: \033[0m",type(sc))
print(sc.dias_regalo)
pro = sc.cambiar_suscripcion(4)
print("\033[1m\033[43mTIPO DE MEMBRESÍA: \033[0m",type(pro))
print(pro.dias_regalo)

g2 = pro.cancelar_suscripcion()
print("\033[1m\033[45;97mTIPO DE MEMBRESÍA: \033[0m",type(g2))
